...
func NewPlayer(x, y float64, index int, sto warehouse.Storage) error {
	...
	spritePath := "images/characters/box_man_sheet_main.png"
	if index%2 == 0 {
		spritePath = "images/characters/box_man_sheet_alt.png"
	}
	err = playerArchetype.Generate(1,
		...
		input.ActionBuffer{ReceiverIndex: index},
		client.CameraIndex(index),

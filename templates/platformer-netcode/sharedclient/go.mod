module github.com/TheBitDrifter/bappacreate/templates/platformer-netcode/sharedclient
...
require (
	...
	github.com/TheBitDrifter/bappa/tteokbokki v0.0.0-20250420132432-5606172c9a41
